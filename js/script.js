...
var p = {
    ...
    teclas: document.querySelectorAll("#calculadora ul li"), // Esta es las teclas presionadas de la calculadora
    accion: "",
    digito: "",
    operaciones: document.querySelector("#operaciones"), // Esta es la salida de la calculadora
    cantidadSignos: 0,
